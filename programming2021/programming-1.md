...
さて、本講義の前半部分（第7回目まで)では、**この一行のPython文において何が起こっているのかを理解すること**を目標にしたいと思います。少し控えめすぎる目標と思われるかもしれませんが、Pythonには余りにもたくさんの機能があって、それらを網羅的に把握するのは至難の技ですし、きわめて退屈な作業になってしまいます。それよりは目標を絞ったほうが良いというのが筆者の考えです。また、上記の代入文はもっとも基本的なPythonの文ですから、これをちゃんと理解せずにPythonプログラマになるのも難しいように思います。もちろん理解する前に使ってはいけないというルールはありませんので、どんどんPythonを使って下さい。むしろ、上の代入文で何が起きているのかを大体でも良いので説明できるようになるまでには、かなりの量のプログラミングを行い、実験を重ねなければならないのではないかと思います。残念ながら本講義だけでは、上の代入文を完全に説明しきることはできません。それでも、そこらじゅうの入門書を読みあさった人と同程度には、理解できるようになることを目指したいと思います。
