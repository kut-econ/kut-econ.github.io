...
文字列を1文字ずつ処理する練習です。文字列"Hello, World!"を全ての'l'の後で改行して印字するPythonコードを作成しなさい。出力は以下のようになります。
...
>昔々、おじいさんと、おばあさんが住んでいました。ある朝、おじいさんは山へ芝刈りに、おばあさんは川へ洗濯に行きました。おばあさんが川で洗濯をしていると、川上から大きな桃が、どんぶらこ、どんぶらこと流れてきました。
