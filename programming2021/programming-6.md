...
リストや集合といったミュータブルなビルトインオブジェクトはハッシュ可能ではありません。イミュータブルなビルトインオブジェクトはほとんど全てハッシュ可能ですが、例外はあります。
...
一つ目の例ではタプルをキーに指定していますが、全く問題ありません。一方二つ目の例でもタプルをキーにしていますが、このタプルは[3]というミュータブルな要素(リスト)を持っており、そのためハッシュ可能ではありません。
