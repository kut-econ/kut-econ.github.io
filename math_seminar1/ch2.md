...
- [数理セミナーI (第2回)](#数理セミナーi-第2回)
  - [ディレクトリの作成・削除コマンド](#ディレクトリの作成削除コマンド)
    - [mkdir - ディレクトリを作成する](#mkdir---ディレクトリを作成する)
    - [rmdir - ディレクトリを削除する](#rmdir---ディレクトリを削除する)
...
```bash
# hello2.txtをmydir内に移動してgoodbye.txtに名前変更
$ mv hello2.txt mydir/goodbye.txt
```
